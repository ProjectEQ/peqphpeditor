...
$sp_effects = array(
    ...
    483 => "Spell Damage Percent",
    484 => "Spell Damage Amount",
    485 => "Limit: Caster Class",
    486 => "Limit: Same Caster",
    487 => "Extend Tradeskill Cap",
    488 => "Defender Melee Force Percent",
    ...
    500 => "FC Cast Time Mod 2",
    501 => "FC Cast Time Amount",
    502 => "Fearstun",
    ...
    507 => "FC Amplify Mod",
    508 => "FC Amplify Amount",
    509 => "Health Transfer",
    510 => "FC Resist Incoming",
    511 => "FF Focus Timer Min",
