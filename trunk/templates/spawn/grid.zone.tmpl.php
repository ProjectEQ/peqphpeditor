...
<?$x=0; foreach($grids as $grid=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="right">
            <a href="index.php?editor=spawn&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&pathgrid=<?=$v['pathgrid']?>&action=66"><img src="images/view_all.gif" height="15" width="15" border="0" title="View spawngroups on this grid"></a>&nbsp;
