...
<? if (isset($grids)):?>
         <tr>
          <td align="center" width="15%"><strong>Number</strong></td>
          ...
          <td align="center" width="15%"><strong>Heading</strong></td>
          <td align="center" width="12%"><strong>Pause</strong></td>
          <th width="5%"></th>
         </tr>
<?$x=0; foreach($grids as $number=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "AAAAAA" : "BBBBBB";?>">
          <td align="center" width="15%"><?=$number?></td>
          <td align="center" width="15%"><?=$v['x_coord']?></td>
          <td align="center" width="15%"><?=$v['y_coord']?></td>
          <td align="center" width="15%"><?=$v['z_coord']?></td>
          <td align="center" width="15%"><?=$v['heading']?></td>
          <td align="center" width="12%"><?=$v['pause']?></td>
          <td align="right">      
