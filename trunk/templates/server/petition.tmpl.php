...
<? if (isset($petitions)) :?>
      ...
      <?$x=0; foreach($petitions as $petitions=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "AAAAAA" : "BBBBBB";?>">
          ...
          <td align="right">      
            <a href="index.php?editor=server&dib=<?=$v['dib']?>&action=13"><img src="images/edit2.gif" border="0" title="View Petition"></a>            
            <a onClick="return confirm('Really Delete Petition <?=$v['dib']?>?');" href="index.php?editor=server&dib=<?=$v['dib']?>&action=15"><img src="images/remove3.gif" border="0" title="Delete this petition"></a>
         </td>
       </tr>
        <?$x++; endforeach;?>
         </table>
