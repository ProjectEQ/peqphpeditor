  ...
  <div class="edit_form_content">
    <form name="aa_edit" method="post" action="index.php?editor=aa<?if($editmode == 1) echo "&aaid=$aaid";?>&action=<? if($editmode==1) echo "15"; else echo "16";?>">
      ...
      <table>
        <tr>
          <td style="width:228px;">
            <fieldset><legend><b>Level and Cost</b></legend>
              <table>
                <tr>
                  <td>
                    Ranks: <br />
          ...
          <td style="width:240px;">
            <fieldset><legend><b>Prerequisite</b></legend>
              <table>
                <tr>
                  <td width="50%">
            ...
            <fieldset><legend><b>Classes</b></legend>
              <table>
                <tr>
                  <td>
            ...
            <div style="margin-top:2px;">
            <fieldset><legend><b>String IDs</b></legend>
              <table>
                <tr>
      ...
      <table>
        <tr>
          <td>
            <fieldset><legend><b>Spell</b></legend>
              <table cellpadding="0">
                <tr>
                  <td style="width:110px;">
                    Spell ID: <br />
