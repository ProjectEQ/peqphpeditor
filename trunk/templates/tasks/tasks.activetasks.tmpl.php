...
foreach($active_tasks as $task):?>
            <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
              ...
              <td align="right"><a onClick="return confirm('Really delete <?=getTaskTitle($task['taskid'])?> from <?=getPlayerName($task['charid'])?>?');" href="index.php?editor=tasks&tskid=<?=$task['taskid']?>&charid=<?=$task['charid']?>&action=37"><img src="images/remove3.gif" border="0" title="Delete Active Task"></a></td>
            </tr>
<?$x++;
endforeach;
else:?>
