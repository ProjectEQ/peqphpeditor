<form name="spell_edit" method="post" action="index.php?editor=spells&id=<?=$id?>&action=6">
       <div class="edit_form">
         <div class="edit_form_header">
             ...
             <!-- <a href="index.php?editor=spells&action=8"><img src="images/add.gif" border=0 title="Add a Spell"></a> -->
         ...
         <fieldset style="text-align:left;">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td width="16%">Range: <br><input type="text" name="range" size="5" value="<?=$range?>"></td>
                <td width="16%">Mana: <br><input type="text" name="mana" size="5" value="<?=$mana?>"></td>
                <td width="16%">AOE Range: <br><input type="text" name="aoerange" size="5" value="<?=$aoerange?>"></td>
                <td width="16%">Push Back: <br><input type="text" name="pushback" size="5" value="<?=$pushback?>"></td>
                <td width="16%">Push Up: <br><input type="text" name="pushup" size="5" value="<?=$pushup?>"></td>
         ...
         <fieldset style="text-align:left;">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td width="25%">
                  <input type="checkbox" name="deities1" <? echo $deities1 ? "checked" : "" ?>> Bertoxxulos<br>
