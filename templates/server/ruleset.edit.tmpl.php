<div class="edit_form" style="width: 200px">
      <div class="edit_form_header">
       ...
       <tr>
        ...
        <td align="right">   
        <a onClick="return confirm('Really Delete Ruleset <?=$ruleset_id?>?');" href="index.php?editor=server&ruleset_id=<?=$ruleset_id?>&action=24"><img src="images/remove3.gif" border="0" title="Delete this rule"></a>
        </td>
        </tr>
         </table>
        </div>
