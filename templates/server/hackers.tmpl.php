...
<?echo (($sort != '') ? '<input type="hidden" name="sort" value="' . $sort . '"/>' : '')?>
    ...
    <div id="action_buttons_top" style="display:none;">
      <center><input type="button" value="Delete Marked" onClick="pushIdArray();">&nbsp;<input type="button" value="Cancel" onClick="location.reload();"></center><br/>
    </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="right" width="33%">
              <a onClick="document.getElementById('filter_box').style.display='block';"><img src="images/filter.jpg" border="0" height="13" width="13" title="Show filter"></a>&nbsp;<a onClick="toggleMultiDelete();"><img id="multiD" src="images/remove3.gif" border="0" height="13" width="13" title="Delete multiple"></a><a id="select_all" onClick="toggleSelectAll();" style="display:none;">Select All</a>
            </td>
          </tr>
        </table>
      </div>
...
<?$x=0; foreach($hackers as $hackers=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="center" width="10%"><a href="index.php?editor=account&acctid=<?echo getAccountID($v['account'])?>"><?=$v['account']?></a></td>
...
<?endif;?>
    ...
    <div id="action_buttons_bottom" style="display:none;">
      <br/><center><input type="button" value="Delete Marked" onClick="pushIdArray();">&nbsp;<input type="button" value="Cancel" onClick="location.reload();"></center>
    </div>
