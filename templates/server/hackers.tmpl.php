          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td align="right" width="33%">
                <a onClick="document.getElementById('filter_box').style.display='block';document.getElementById('filter_image').style.display='none';"><img id="filter_image" src="images/filter.jpg" border="0" height="13" width="13" title="Show filter"<?echo (isset($filter) && $filter['status'] == 'on') ? ' style="display:none;"' : '';?>></a>&nbsp;<a onClick="toggleMultiDelete();"><img id="multiD" src="images/remove3.gif" border="0" height="13" width="13" title="Delete multiple"></a><a id="select_all" onClick="toggleSelectAll();" style="display:none;">Select All</a>
              </td>
            </tr>
          </table>
        </div>
...
<?if (isset($hackers)) :?>
          <tr>
            <td align="center"><strong><?echo ($sort == 1) ? "ID <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=1" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>ID <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by ID'></a>";?></strong></td>
            <td align="center"><strong><?echo ($sort == 2) ? "Account <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=2" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>Account <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Account'></a>";?></strong></td>
            <td align="center"><strong><?echo ($sort == 3) ? "Name <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=3" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>Name <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Name'></a>";?></strong></td>
            <td align="center"><strong><?echo ($sort == 4) ? "Zone <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=4" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>Zone <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Zone'></a>";?></strong></td>
            <td align="center"><strong><?echo ($sort == 5) ? "Date <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=5" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>Date <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Date'></a>";?></strong></td>
            <td align="center"><strong><?echo ($sort == 6) ? "Hack <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=6&sort=6" . ((isset($filter) && $filter['status'] == 'on') ? $filter['url'] : '') . "'>Hack <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Hack'></a>";?></strong></td>
            <td width="10%">&nbsp;</td>
          </tr>
