...
<?if (isset($bugs)) :?>
            <tr>
              ...
              <td align="center" width="15%"><strong><?echo ($sort == 3) ? "Player <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=4&sort=3'>Player <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Player'></a>";?></strong></td>
              ...
              <td align="center" width="20%"><strong><?echo ($sort == 6) ? "Date <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=4&sort=6'>Date <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Date'></a>";?></strong></td>
              <td align="center" width="10%"><strong><?echo ($sort == 7) ? "Status <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=server&action=4&sort=7'>Status <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Status'></a>";?></strong></td>
              <td width="5%">&nbsp;</td>
            </tr>
...
<?if($bug['bug_status'] != 0):?>
            <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
              ...
              <td align="right"><a href="index.php?editor=server&id=<?=$bug['id']?>&action=2"><img src="images/edit2.gif" border="0" title="View Entry"></a></td>
              <td align="right"><a onClick="return confirm('Really Delete Report <?=$bug['id']?>?');" href="index.php?editor=server&id=<?=$bug['id']?>&action=5"><img src="images/remove3.gif" border="0" title="Delete Entry"></a></td>
            </tr>
<?endif;?>
<?$x++; endforeach;?>
<?endif;?>
