...
<?$x=0; foreach($spawncv as $spawn=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="right">
            <a href="index.php?editor=spawn&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&npcid=<?=$npcid?>&spid=<?=$spid?>&scid=<?=$scid?>&instance_id=<?=$v['instance_id']?>&action=82"><img src="images/edit2.gif" border="0" title="Edit this entry"></a>&nbsp;
<? if ($v['instance_id'] > 0 ):?>    
