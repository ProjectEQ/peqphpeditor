        ...
        <div class="edit_form_content">
          <form method="post" action="index.php?editor=spawn&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&action=17">
            <center>
              ...
              <strong>First NPCID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Chance:&nbsp;&nbsp;</strong><br>
              &nbsp;&nbsp;<input type="text" name="npcID" size="5" value="<?=$npcid?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="chance" size="1" value="100">&nbsp;%<br><br>
              <strong>dist:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;delay:</strong><br>
              <input type="text" name="dist" size="5" value="0">&nbsp;&nbsp;&nbsp;<input type="text" name="delay" size="5" value="0"><br><br>
              <strong>max_x:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; min_x:</strong><br>
              <input type="text" name="max_x" size="5" value="0">&nbsp;&nbsp;&nbsp;<input type="text" name="min_x" size="5" value="0"><br><br>
              <strong>max_y:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; min_y:</strong><br>
              <input type="text" name="max_y" size="5" value="0">&nbsp;&nbsp;&nbsp;<input type="text" name="min_y" size="5" value="0"><br><br>
