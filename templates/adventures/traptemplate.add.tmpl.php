...
<?endforeach;?>
        ...
        <input id="id" type="text" name="spell_id" size="5" value="<?=$spell_id?>"><br><br>
        <strong>Skill:</strong><br>
        <input type="text" name="skill" size="5" value="<?=$skill?>"><br><br>
