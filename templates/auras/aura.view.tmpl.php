  <div class="table_container" style="width: 550px;">
    ...
    <table class="table_content" width="100%" cellpadding="3" cellspacing="0">
      <tr>
        <td><strong>Type:</strong> <?echo getSpellName($aura['type']) . " (" . $aura['type'] . ")" . " [<a href='https://lucy.allakhazam.com/spell.html?source=Live&id=" . $aura['type'] . "' target='_blank'>Lucy</a>]"?><br><br></td>
      ...
      <tr>
        <td colspan="2"><strong>Spell:</strong> <?echo getSpellName($aura['spell_id']) . " (" . $aura['spell_id'] . ")" . " [<a href='https://lucy.allakhazam.com/spell.html?source=Live&id=" . $aura['spell_id'] . "' target='_blank'>Lucy</a>]"?><br><br></td>
