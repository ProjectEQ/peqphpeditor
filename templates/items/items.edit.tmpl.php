...
<?endforeach;?>       
          ...
          <fieldset>
            ...
            <table cellpadding="20px">
              <tr>
                <td valign="top" align="left">Deity:<br/>
...
<?endforeach;?>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td align="left" width="14%">Proc Type:<br/>
...
<?endforeach;?>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td align="left" width="14%">Worn Type:<br/>
...
<?endforeach;?>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td align="left" width="14%">Focus Type:<br/>
...
<?endforeach;?>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
                <td align="left" width="14%">Scroll Type:<br/>
