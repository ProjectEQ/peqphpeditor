 <form name="item_edit" method="post" action="index.php?editor=items&id=<?=$id?>&action=6">
       <div class="edit_form">
          ...
          <select name="itemtype" style="width: 265px;">
              ...
              <option value="<?=$k?>"<? echo ($k == $itemtype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               <?endforeach;?>       
                ...
                <tr>
                 <?if($filename != ''):?>
                 <td align="left" width="25%"><a href="index.php?editor=items&id=<?=$id?>&name=<?=$filename?>&action=3">File Name: <br><input type="text" name="filename" size="20" value="<?=$filename?>"></td>
                 <?endif;?>
                  <?if($filename == ''):?>
                 <td align="left" width="33%">File Name: <br><input type="text" name="filename" size="20" value="<?=$filename?>"></td>
                 <?endif;?>
		 ...
		 <table width="100%" border="0" cellpadding="3" cellspacing="0">
                <tr>
                <td align="left" width="33%">Charmfile: <br><input type="text" name="charmfile" size="20" value="<?=$charmfile?>"></td>
		...
		Tradeskill:  <br>
              ...
              <tr>
                 ...
                 <td align="left" width="16%">
                 Lore:  <br><input type="text" name="loregroup" size="5" value="<?=$loregroup?>">
                      </td>
                <td align="left" width="16%">
                 Req Level:  <br><input type="text" name="reqlevel" size="5" value="<?=$reqlevel?>">
                      </td>
                 <td align="left" width="16%">
                 Rec Level:  <br><input type="text" name="reclevel" size="5" value="<?=$reclevel?>">
                      </td>
                 <td align="left" width="16%">
                 Rec Skill:  <br><input type="text" name="recskill" size="5" value="<?=$recskill?>">
                      </td>
                 <td align="left" width="16%">
                 Evolving Level:  <br><input type="text" name="evolvinglevel" size="5" value="<?=$evolvinglevel?>">
                      </td>
               </tr>
           </table>
        ...
        <input id="button" type="button" value='Hide Spell Search' onclick='hideSearch();' style='display:none; margin-bottom: 20px;'>
          ...
          <select class="left" name="proctype">
              ...
              <option value="<?=$k?>"<? echo ($k == $proctype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               ...
               <td align="left" width="14%">Proc Effect:   <br><input type="text" name="proceffect" size="5" value="<?=$proceffect?>"></td>
               <td align="left" width="14%">Proc Level:  <br><input type="text" name="proclevel" size="5" value="<?=$proclevel?>"></td>
               <td align="left" width="14%">Proc Level 2:  <br><input type="text" name="proclevel2" size="5" value="<?=$proclevel2?>"></td>
               <td align="left" width="20%">Proc Name:  <br><input type="text" name="procname" size="17" value="<?=$procname?>"></td>
              </tr>
            </table>
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
          ...
          <select class="left" name="worntype">
              ...
              <option value="<?=$k?>"<? echo ($k == $worntype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               ...
               <td align="left" width="14%">Worn Effect:   <br><input type="text" name="worneffect" size="5" value="<?=$worneffect?>"></td>
               <td align="left" width="14%">Worn Level:  <br><input type="text" name="wornlevel" size="5" value="<?=$wornlevel?>"></td>
               <td align="left" width="14%">Worn Level 2:  <br><input type="text" name="wornlevel2" size="5" value="<?=$wornlevel2?>"></td>
               <td align="left" width="20%">Worn Name:  <br><input type="text" name="wornname" size="17" value="<?=$wornname?>"></td>
              </tr>
            </table>
              <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
          ...
          <select class="left" name="focustype">
              ...
              <option value="<?=$k?>"<? echo ($k == $focustype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               ...
               <td align="left" width="14%">Focus Effect:  <br><input type="text" name="focuseffect" size="5" value="<?=$focuseffect?>"></td>
               <td align="left" width="14%">Focus Level:  <br><input type="text" name="focuslevel" size="5" value="<?=$focuslevel?>"></td>
               <td align="left" width="14%">Focus Level 2:  <br><input type="text" name="focuslevel2" size="5" value="<?=$focuslevel2?>"></td>
               <td align="left" width="20%">Focus Name:  <br><input type="text" name="focusname" size="17" value="<?=$focusname?>"></td>
              </tr>
            </table>
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
          ...
          <select class="left" name="scrolltype">
              ...
              <option value="<?=$k?>"<? echo ($k == $scrolltype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               ...
               <td align="left" width="14%">Scroll Effect: <br><input type="text" name="scrolleffect" size="5" value="<?=$scrolleffect?>"></td>
               <td align="left" width="14%">Scroll Level:  <br><input type="text" name="scrolllevel" size="5" value="<?=$scrolllevel?>"></td>
               <td align="left" width="14%">Scroll Level 2:  <br><input type="text" name="scrolllevel2" size="5" value="<?=$scrolllevel2?>"></td>
               <td align="left" width="20%">Scroll Name:  <br><input type="text" name="scrollname" size="17" value="<?=$scrollname?>"></td>
              </tr>
            </table>
            <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
		 ...
		 <td valign="top" align="left">
          ...
          <fieldset>
           <legend><strong><font size="4">Faction</font></strong></legend>
            ...
            <center>
              <tr>
               <td align="left" width="25%">Faction Mod 1:  <br><input type="text" name="factionmod1" size="5" value="<?=$factionmod1?>"></td>
               <td align="left" width="25%">Faction Amt 1:  <br><input type="text" name="factionamt1" size="5" value="<?=$factionamt1?>"></td>
               <td align="left" width="25%">Faction Mod 2:  <br><input type="text" name="factionmod2" size="5" value="<?=$factionmod2?>"></td>
               <td align="left" width="25%">Faction Amt 2:  <br><input type="text" name="factionamt2" size="5" value="<?=$factionamt2?>"></td>
            </table>
               </tr>
             <table width="100%" border="0" cellpadding="3" cellspacing="0">
              <tr>
               <td align="left" width="25%">Faction Mod 3:  <br><input type="text" name="factionmod3" size="5" value="<?=$factionmod3?>"></td>
               <td align="left" width="25%">Faction Amt 3:  <br><input type="text" name="factionamt3" size="5" value="<?=$factionamt3?>"></td>
               <td align="left" width="25%">Faction Mod 4:  <br><input type="text" name="factionmod4" size="5" value="<?=$factionmod4?>"></td>
               <td align="left" width="25%">Faction Amt 4:  <br><input type="text" name="factionamt4" size="5" value="<?=$factionamt4?>"></td>
            </table>
               </tr>
            </center>
         </fieldset><br>
