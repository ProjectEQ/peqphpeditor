      ...
      <div class="edit_form_content">
        <table width="100%" cellpadding="5" cellspacing="5">
          <tr>
            ...
            <td align="left"><strong>Item ID:</strong><br><input type="text" name="item_id" id="item_search" size="10" value=""></td>
          </tr>
          <tr>
            <td align="left">
...
<?endforeach;?>
            ...
            <td align="left"><strong>Subtype:</strong><br><input type="text" name="sub_type" size="10" value=""></td>
            <td align="left"><strong>Required Amt:</strong><br><input type="text" name="required_amount" size="10" value=""></td>
            <td align="left">&nbsp;</td>
          </tr>
        </table><br>
        <center>
