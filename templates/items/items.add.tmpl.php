        ...
        <input id="button" type="button" value='Hide Spell Search' onclick='hideSearch();' style='display:none; margin-bottom: 20px;'>
          ...
          <select class="left" name="bardtype">
              ...
              <option value="<?=$k?>"<? echo ($k == $bardtype) ? " selected" : ""?>><?=$k?>: <?=$v?></option>
               ...
               <td align="left" width="14%">Bard Effect:  <br><input type="text" name="bardeffect" size="5" value="-1"></td>
               <td align="left" width="14%">Bard Level:  <br><input type="text" name="bardlevel" size="5" value="0"></td>
               <td align="left" width="14%">Bard Level 2:  <br><input type="text" name="bardlevel2" size="5" value="0"></td>
               <td align="left" width="16%">Bard Value:  <br><input type="text" name="bardvalue" size="5" value="0"></td>
               <td align="left" width="20%">Bard Name:  <br><input type="text" name="bardname" size="17" value=""></td>
