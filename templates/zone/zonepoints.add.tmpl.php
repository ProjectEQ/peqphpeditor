<div class="edit_form" style="width: 600px">
      ...
      <div class="edit_form_content">
        <form name="zonepoints" method="post" action=index.php?editor=zone&z=<?=$currzone?>&action=17">
        <table width="100%">
          <tr>
            <th>ID</th>
            <th>Zone</th>
