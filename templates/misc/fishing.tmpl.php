...
<?$x=0; foreach($fishing as $fishing=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "AAAAAA" : "BBBBBB";?>">
          ...
          <td align="center" width="12%"><a href="index.php?editor=items&z=<?=$currzone?>&id=<?=$v['fiid']?>&action=2"><?=$v['name']?></a> <span>[<a href="http://lucy.allakhazam.com/item.html?id=<?=$v['fiid']?>">lucy</a>]</span></td>
