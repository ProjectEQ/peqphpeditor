...
<?$x=0; foreach($forage as $forage=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="center" width="20%"><a href="index.php?editor=items&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&id=<?=$v['fgiid']?>&action=2"><?=$v['name']?></a> <span>[<a href="https://lucy.allakhazam.com/item.html?id=<?=$v['fgiid']?>" target="_blank">Lucy</a>]</span></td>
