...
if(isset($_GET['name']) && ($_GET['name'] != '')) {
  ...
  $query = "SELECT id, name FROM character_data WHERE name RLIKE \"$name\" LIMIT 50";
  ...
  if ($results == '') {
    ...
    foreach($results as $result) {
      extract($result);
      echo "<li><a href=\"javascript:parent.document.getElementById('player').value='$id';parent.hideSearch();\">$id: $name</a></li>";
    }
    echo "</ul>";
  }
}
