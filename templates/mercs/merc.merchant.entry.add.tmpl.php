  <div class="table_container" style="width: 500px;">
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td>Create Mercenary Merchant Entry</td>
        </tr>
      </table>
    </div>
    <div class="table_content">
      <form name="add_mercenary_merchant_entry" method="post" action="index.php?editor=mercs&action=98">
        <table width="100%" cellpadding="5" cellspacing="5">
          <tr>
            <td>
              <strong>ID:</strong><br>
              <input type="text" name="merc_merchant_entry_id" size="10" value="<?=$suggest_id?>">
            </td>
            <td>
            ...
            <td>
              ...
              <input type="text" name="merchant_id" size="10" value="">
            </td>
          </tr>
        </table><br>
        <center>
