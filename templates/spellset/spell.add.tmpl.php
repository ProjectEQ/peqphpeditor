      ...
      <div class="table_container" style="width: 125px">
        ...
        <div class="edit_form_content">
          <form method="post" action="index.php?editor=spellset&z=<?=$currzone?>&npcid=<?=$npcid?>&spellset=<?=$spellset?>&action=4">
            ...
            <input id="spellid" type="text" name="spellid" size="10" value=""><br><br>
...
<?endforeach;?>
            ...
            <input type="text" name="minlevel" size="10" value="1"><br><br>

            <strong>Maxlevel:</strong><br>
            <input type="text" name="maxlevel" size="10" value="255"><br><br>

            <strong>Mana Cost:</strong><br>
            <input type="text" name="manacost" size="10" value="-1"><br>
            (-1 = Default)<br><br>

            <strong>Recast Delay:</strong><br>
            <input type="text" name="recast_delay" size="10" value="-1"><br>
            (-1 = Default)<br><br>

            <strong>Priority:</strong><br>
            <input type="text" name="priority" size="10" value="0"><br><br>
