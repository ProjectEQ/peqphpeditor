...
<?if (isset($qglobals)):?>
        <tr>
          <td align="center"><strong><?echo ($sort == 1) ? "Name <img src='images/sort_red.bmp' border='0' width='8' height='8' alt='Sort'>" : "<a href='index.php?editor=qglobal&sort=1" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Name <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Name' alt='Sort'></a>";?></strong></td>
          <td align="center"><strong>Value</strong></td>
          <td align="center"><strong><?echo ($sort == 2) ? "Character <img src='images/sort_red.bmp' border='0' width='8' height='8' alt='Sort'>" : "<a href='index.php?editor=qglobal&sort=2" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Character <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Character' alt='Sort'></a>";?></strong></td>
          <td align="center"><strong><?echo ($sort == 3) ? "NPC <img src='images/sort_red.bmp' border='0' width='8' height='8' alt='Sort'>" : "<a href='index.php?editor=qglobal&sort=3" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>NPC <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by NPC' alt='Sort'></a>";?></strong></td>
          <td align="center"><strong><?echo ($sort == 4) ? "Zone <img src='images/sort_red.bmp' border='0' width='8' height='8' alt='Sort'>" : "<a href='index.php?editor=qglobal&sort=4" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Zone <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Zone' alt='Sort'></a>";?></strong></td>
