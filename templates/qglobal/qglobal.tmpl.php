...
<?if (isset($qglobals)):?>
        <tr>
          <td align="center"><strong><?echo ($sort == 1) ? "ID <img src='images/sort_red.bmp' border='0' width='8' height='8'/>" : "<a href='index.php?editor=qglobal&sort=1" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>ID <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by ID'/></a>";?></strong></td>
          <td align="center"><strong><?echo ($sort == 2) ? "Name <img src='images/sort_red.bmp' border='0' width='8' height='8'/>" : "<a href='index.php?editor=qglobal&sort=2" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Name <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Name'/></a>";?></strong></td>
          <td align="center"><strong>Value</strong></td>
          <td align="center"><strong><?echo ($sort == 3) ? "Character <img src='images/sort_red.bmp' border='0' width='8' height='8'/>" : "<a href='index.php?editor=qglobal&sort=3" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Character <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Character'/></a>";?></strong></td>
          <td align="center"><strong><?echo ($sort == 4) ? "NPC <img src='images/sort_red.bmp' border='0' width='8' height='8'/>" : "<a href='index.php?editor=qglobal&sort=4" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>NPC <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by NPC'/></a>";?></strong></td>
          <td align="center"><strong><?echo ($sort == 5) ? "Zone <img src='images/sort_red.bmp' border='0' width='8' height='8'/>" : "<a href='index.php?editor=qglobal&sort=5" . (($filter['status'] == "on") ? $filter['url'] : "") . "'>Zone <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Zone'/></a>";?></strong></td>
