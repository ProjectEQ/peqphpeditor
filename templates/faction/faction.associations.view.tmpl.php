...
<?if (isset($faction_associations)):?>
      <tr>
        ...
        <td align="center"><strong>Factions</strong></td>
        <td width="10%">&nbsp;</td>
      </tr>
<?$x=0;
foreach($faction_associations as $faction_association):?>
      <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
        ...
        <td align="center">
          <?=getFactionName($faction_association['id_1'])?> (<?=$faction_association['id_1']?>),
          <?=getFactionName($faction_association['id_2'])?> (<?=$faction_association['id_2']?>),
          <?=getFactionName($faction_association['id_3'])?> (<?=$faction_association['id_3']?>),
          <?=getFactionName($faction_association['id_4'])?> (<?=$faction_association['id_4']?>),
          <?=getFactionName($faction_association['id_5'])?> (<?=$faction_association['id_5']?>),
          <?=getFactionName($faction_association['id_6'])?> (<?=$faction_association['id_6']?>),
          <?=getFactionName($faction_association['id_7'])?> (<?=$faction_association['id_7']?>),
          <?=getFactionName($faction_association['id_8'])?> (<?=$faction_association['id_8']?>),
          <?=getFactionName($faction_association['id_9'])?> (<?=$faction_association['id_9']?>),
          <?=getFactionName($faction_association['id_10'])?> (<?=$faction_association['id_10']?>)
        </td>
