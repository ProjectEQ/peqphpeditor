...
<?echo ((isset($sort) && $sort != '') ? '<input type="hidden" name="sort" value="' . $sort . '">' : '')?>
  ...
  <div class="table_container" style="width: 700px;">
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td align="left" width="33%">Active Tasks [<a href="index.php?editor=tasks&action=36">View Completed Tasks</a>]</td>
          <td align="center" width="33%">
            <?echo ($page > 1) ? "<a href='index.php?editor=tasks&action=35&page=1" . (($sort != "") ? "&sort=" . $sort : "") . (($filter['status'] == "on") ? $filter['url'] : "") . "'><img src='images/first.gif' border='0' width='12' height='12' title='First'></a>" : "<img src='images/first.gif' border='0' width='12' height='12'>";?>
            <?echo ($page > 1) ? "<a href='index.php?editor=tasks&action=35&page=" . ($page - 1) . (($sort != "") ? "&sort=" . $sort : "") . (($filter['status'] == "on") ? $filter['url'] : "") . "'><img src='images/prev.gif' border='0' width='12' height='12' title='Previous'></a>" : "<img src='images/prev.gif' border='0' width='12' height='12'>";?>
            <?echo $page . " of " . $pages;?>
...
<?if (isset($active_tasks)):?>
      <tr>
        <td align="center"><strong><?echo ($sort == 1) ? "Character <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=tasks&action=35&sort=1" . ((isset($filter) && $filter['status'] == "on") ? $filter['url'] : "") . "'>Character <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Character'></a>";?></strong></td>
        <td align="center"><strong><?echo ($sort == 2) ? "Task <img src='images/sort_red.bmp' border='0' width='8' height='8'>" : "<a href='index.php?editor=tasks&action=35&sort=2" . ((isset($filter) && $filter['status'] == "on") ? $filter['url'] : "") . "'>Task <img src='images/sort_green.bmp' border='0' width='8' height='8' title='Sort by Task'></a>";?></strong></td>
